...
public class User {
     ...
     * - true: El seller se ha registrado pero aún no ha sido aprobado por un administrador.
     *   En este estado, el seller no puede registrar ventas ni acceder a todas las funcionalidades.
     * 
     ...
     * 
     * Los administradores (ADMIN) siempre tienen este valor en false porque no requieren
